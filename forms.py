...
class RegistroCitaForm(FlaskForm):
    ...
    especie = SelectField('Especie',
        choices=[('', 'Seleccione...'), ('Perro', 'Perro'), ('Gato', 'Gato')],
        validators=[DataRequired()])

    # IMPORTANTE: Sin DataRequired() para que no bloqueen el envío
    ...
    horario_perro = SelectField('Horario Perros', choices=[
        ('', 'Seleccione horario...'), ('Lun24_12pm', 'Lunes 24 - 12 p.m.'), ('Mar25_9pm', 'Martes 25 - 9 p.m.')
    ])
    ...
    horario_gato = SelectField('Horario Gatos', choices=[
        ('', 'Seleccione horario...'), ('Mar25_12pm', 'Martes 25 - 12 p.m.'), ('Mie26_10am', 'Miércoles 26 - 10 a.m.')
    ])
